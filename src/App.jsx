    ...
    <>
      ...
      <div className='w-100 h-[400px] border border-black flex flex-row p-3 justify-center'>
        <div className=' border border-black w-full h-full flex flex-col'>
          <div className='w-full h-full border border-black flex flex-wrap justify-center items-center'>
          </div>
          <div className=' w-full h-full border border-black flex justify-center items-center'>
          </div>
          <div className='w-full h-full border border-black flex justify-center items-center'>
            <div id='1' className={` w-[50px] h-[50px] border border-red-600 transition-transform duration-300 ease-in-out ${counter === 1 ? " -translate-y-[0px]" : counter === 2 ? " -translate-y-[125px]" : " -translate-y-[250px]"}`}></div>
          </div>

        </div>
        <div className=' border border-black w-full h-full flex justify-center items-center gap-3'>
